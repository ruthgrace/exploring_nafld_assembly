...
```
nohup perl get_seqs_for_kegg.pl all_counts_with_seq_length_zeros_removed.txt all_assembled_no_refseqs_with_sample_name.fa /Volumes/data/ruth/refseqs/all_genus_orfs_clustered_at_99_unique.fa assembled_library_for_kegg.fa constructed_library_for_kegg.faa > get_seqs_for_kegg_nohup.out
```
